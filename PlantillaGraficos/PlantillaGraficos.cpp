...
void checarColisiones() {
	if (
		//Orilla derecha del triangulo es mayor que la orilla izquierda del cuadrado
		posXTriangulo + 0.15f >= posXCuadrado - 0.15f &&
		//orilla izquierda del triangulo es menor que la orilla derecha del cuadrado
		posXTriangulo -0.15f <= posXCuadrado + 0.15f &&
		//orilla superior triangulo mayor que la orilla superior del cuadrado 
		posYTriangulo + 0.15f >= posYCuadrado -0.15f &&
		//orilla infewrior del triangulo es menor que la orilla inferior del cuadrado
		posYTriangulo - 0.15 <=posYCuadrado + 0.15
